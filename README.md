...
Kör `supabase/upgrade_to_sellable_v2.sql` i Supabase SQL Editor.
Därefter kan admin logga in med standardlösenordet `0000` och byta lösenord inne i Admin → Team → Admin-lösenord.

För en publik SaaS-version bör du senare byta från öppna anon-policies till Supabase Auth + riktiga RLS-regler per salong.
